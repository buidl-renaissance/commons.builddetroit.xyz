...
ALTER TABLE `expenses` ALTER COLUMN "payout_status" TO "payout_status" text DEFAULT 'pending_approval';--> statement-breakpoint
...
ALTER TABLE `expenses` ADD `submitted_by` integer;--> statement-breakpoint
ALTER TABLE `expenses` ADD `payout_address` text;--> statement-breakpoint
ALTER TABLE `expenses` ADD `approved_by` text;--> statement-breakpoint
ALTER TABLE `expenses` ADD `approved_at` text;--> statement-breakpoint
ALTER TABLE `expenses` ADD `rejected_by` text;--> statement-breakpoint
ALTER TABLE `expenses` ADD `rejected_at` text;--> statement-breakpoint
ALTER TABLE `expenses` ADD `rejection_reason` text;--> statement-breakpoint
ALTER TABLE `members` ADD `payout_address` text;--> statement-breakpoint
ALTER TABLE `members` ADD `payout_address_verified` integer DEFAULT false;