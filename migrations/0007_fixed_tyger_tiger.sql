...
ALTER TABLE `open_october_registrations` ALTER COLUMN "message" TO "message" text;--> statement-breakpoint
...
ALTER TABLE `projects` ALTER COLUMN "status" TO "status" text DEFAULT 'draft';--> statement-breakpoint
ALTER TABLE `projects` ADD `submitted_at` text;--> statement-breakpoint
ALTER TABLE `projects` ADD `reviewed_at` text;--> statement-breakpoint
ALTER TABLE `projects` ADD `reviewed_by` text;--> statement-breakpoint
ALTER TABLE `projects` ADD `review_notes` text;--> statement-breakpoint
ALTER TABLE `builder_invitations` ADD `invited_by_name` text;--> statement-breakpoint
ALTER TABLE `builder_invitations` ADD `invited_by_modification_key` text;